...
### Step 2.5: Expose via External Ingress (HTTPS + Reserved Static IP)

Create `ingress.yaml` to bind the Google Cloud External Load Balancer:
...
### Step 2.6: Apply Manifests via the IAP Bastion
